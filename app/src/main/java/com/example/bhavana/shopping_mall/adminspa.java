...
public class adminspa extends AppCompatActivity implements View.OnClickListener{
...
//    String movie,shwtimes,vacancy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adminspa);
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS spa(Movie_name VARCHAR,Show_times INTEGER);");
    }
    ...
    public void onClick(View view) {
        ...
        if (view == btnAdd) {
            ...
            // Inserting record 
            db.execSQL("INSERT INTO spa VALUES('" + editRollno.getText() + "','" + editName.getText()+"');");
...
*/
        ...
        if (view == btnViewAll) {
            ...
            Cursor c = db.rawQuery("SELECT * FROM spa", null);
            ...
            while (c.moveToNext())
            {
                buffer.append("massage: " + c.getString(0) + "\n");
