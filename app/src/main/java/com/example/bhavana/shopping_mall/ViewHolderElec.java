...
public class ViewHolderElec extends RecyclerView.Adapter<ViewHolderElec.MyHoder>{

    List<ModelElec> list;
    Context context;

    public ViewHolderElec(List<ModelElec> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(final MyHoder holder, int position) {
        final ModelElec mylist = list.get(position);
